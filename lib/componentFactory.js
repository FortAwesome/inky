...
module.exports = function (element) {
  ...
  switch (element[0].name) {
    ...
    case this.components.priceTable:
      ...
      if (title && element) {
        return format(
          '<table class="pricing-table display-table" role="table"><tr><td><h5>%s</h5></td><td><p class="text-right"><strong>%s</strong></p></td></tr></table>',
          title,
          total
        );
      }
      ...
      return format(
        '<table class="pricing-table display-table" role="table">%s</table>',
        inner
      );
